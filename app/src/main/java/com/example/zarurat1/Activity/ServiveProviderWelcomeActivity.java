...
import com.example.zarurat1.Fragment.AddServiceCategoryFragment;
import com.example.zarurat1.R;


public class ServiveProviderWelcomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_servive_provider_welcome);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.servive_provider_welcome, menu);
        return true;
    }
